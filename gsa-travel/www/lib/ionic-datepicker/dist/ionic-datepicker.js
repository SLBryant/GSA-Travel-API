    ...
    return {
        ...
        link: function(a, n) {
            ...
            a.today = {
                ...
                epochLocal: s.getTime(),
                epochUTC: s.getTime() + 60 * s.getTimezoneOffset() * 1e3
            };
            var c = function(e) {
            ...
            a.monthChanged = function(e) {
                ...
                if (a.ipDate) c(angular.copy(a.ipDate));
                else {
                    var t = new Date;
                    c(t)
                }
                        ...
                        onTap: function(e) {
                            var t = new Date,
                                ...
                                o = {
                                    ...
                                    epochLocal: n.getTime(),
                                    epochUTC: n.getTime() + 60 * n.getTimezoneOffset() * 1e3
                                };
                            a.selctedDateString = o.dateString, a.date_selection.selected = !0, a.date_selection.selectedDate = new Date(o.dateString), c(new Date), e.preventDefault()
                        }
                    }, {
                        text: "Set",
